...
enum {
    ...
    SBT_DEVMODEL_SSI_CS6080              = 0x03,
    SBT_DEVMODEL_SSI_LI3678              = 0x04,
    SBT_DEVMODEL_SSI_DS3678              = 0x05,
    SBT_DEVMODEL_SSI_DS8178              = 0x06,
    SBT_DEVMODEL_SSI_DS2278              = 0x07,
    SBT_DEVMODEL_SSI_GENERIC             = 0x08,
    SBT_DEVMODEL_RFID_RFD8500            = 0x09
};
